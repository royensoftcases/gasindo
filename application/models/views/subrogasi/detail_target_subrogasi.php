...
<section class="browse-jobs">
         <div class="container">
            <div class="row justify-content-center">
                <br>
                <br>
                <h5 class="text-center" style="color: blue">LIST DATA TARGET BEBAN KLAIM TAHUN <?php echo $tahun;?></h5>
            </div>
        </div>
        <br>
        <div class="col-md-12">
                 <div class="pull-right">
                 <a href="?page=upload_target_subrogasi"><button class="btns-success btns-sm"style="font-size: 13px;"><i class="fa fa-backward"></i> KEMBALI SEBELUMNYA</button></a>
                </div>
            </div>
            <br>
             <br>
   ...
   <script src="<?php echo base_url();?>assets/js/jquery-3.3.1.js"></script>
    ...
    $(document).ready(function () {
        ...
        var t = $('#mytable').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "index.php/Subrogasi/dataTargetSubrogasi/"+tahun,
            fixedColumns: {
                leftColumns: 1,
                rightColumns: 0
            },
