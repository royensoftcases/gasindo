 ...
 ?>
  <section class="browse-job">
          <div class="container" style="padding-bottom: 20px;width:100%;">
                  <h4 style="text-align: center;"><b>IJP</b></h4>         
                </div>
                  <div class="container" style="padding-bottom: 20px;width:100%;">  
...
filterBank=<?php echo json_encode($filterBank); ?>;
 ...
 $.post("index.php/Ijp/filterbulanWilayahPencapaian", {
        ...
        targetWilayah.push(getNum(parseInt(data[i]['ijp'])),);
        dataPersenWilayah.push(getNum(((parseInt(data[i]['pokok_kredit_now']) / parseInt(data[i]['ijp']))*(100)).toFixed(0)),);
  ...
  $.post("index.php/Ijp/filterbulanIjpJenisProduk", {
     filterBulan: filterBulan,
     filterWilayah: filterWilayah,
     filterTipeProduk: filterTipeProduk,
     filterPerProduk: filterPerProduk,
     filterBank: filterBank
            ...
            function (data, status) {
              ...
              var data = JSON.parse(data);
              for (var i = 0; i < data.length; i++) {
        targetProduk.push(getNum(parseInt(data[i]['ijp'])),);
        realisasiProduk.push(getNum(parseInt(data[i]['pokok_kredit'])),);
        dataPersenProduk.push(getNum(((parseInt(data[i]['pokok_kredit']) / parseInt(data[i]['ijp']))*(100)).toFixed(0)),);
  ...
  $.post("index.php/Ijp/filterbulanIjpProduk", {
    filterBulan: filterBulan,
    filterWilayah: filterWilayah,
    filterTipeProduk: filterTipeProduk,
    filterPerProduk: filterPerProduk,
    filterBank: filterBank
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        targetperProduk.push(getNum(parseInt(data[i]['ijp'])),);
        dataPersenPerProduk.push(getNum(((parseInt(data[i]['pokok_kredit']) / parseInt(data[i]['ijp']))*(100)).toFixed(0)),);
  ...
  $.post("index.php/Ijp/filterbulanGrowthProduk", {
    filterBulan: filterBulan,
    filterWilayah: filterWilayah,
    filterTipeProduk: filterTipeProduk,
    filterPerProduk: filterPerProduk,
  ...
  $.post("index.php/Ijp/filterbulanGrowthMitra", {
     filterBulan: filterBulan,
     filterWilayah: filterWilayah,
     filterTipeProduk: filterTipeProduk,
     filterPerProduk: filterPerProduk,
