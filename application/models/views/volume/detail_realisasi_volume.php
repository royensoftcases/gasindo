...
<section class="browse-jobs">
         <div class="container">
            <div class="row justify-content-center">
                <br>
                <br>
                <h5 class="text-center" style="color: blue">LIST DATA REALISASI BULAN <?php echo $bulan;?> TAHUN <?php echo $tahun;?></h5>
            </div>
        </div>
        <br>
        <div class="col-md-12">
                 <div class="pull-right">
                 <a href="?page=upload_realisasi_volume"><button class="btns-success btns-sm"style="font-size: 13px;"><i class="fa fa-backward"></i> KEMBALI SEBELUMNYA</button></a>
                </div>
            </div>
            <br>
             <br>
        ...
        <thead>
           <tr>
                            ...
                            <th>JENIS PRODUK</th>
                            <th>PRODUK</th>
                            <th>BANK/LEMBAGA KEUANGAN</th>
                            <th>POKOK KREDIT/PEMBIAYAAN</th>
                            <th>IJP/IJK</th>
            </tr>
        </thead>
    </table>
   ...
   <script src="<?php echo base_url();?>assets/js/jquery-3.3.1.js"></script>
    ...
    $(document).ready(function () {
        ...
        var t = $('#mytable').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "index.php/Volume/dataRealisasi/"+tahun+"/"+bulan,
            fixedColumns: {
                leftColumns: 5,
                rightColumns: 0
            },
