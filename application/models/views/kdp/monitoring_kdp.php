...
$("input:radio[name=filterTahun]:checked").each(function(){
  ...
  $.post("index.php/Kdp/monitoringWilayah", {
      ...
      categoriesWilayahNama.push(data[i]['wilayah'],);
      categoriesWilayahSeries.push(data[i]['wilayah']+","+getNum(parseInt(data[i]['total'])),);
      }
  ...
  $.post("index.php/Kdp/monitoringProduk", {
        filterTahun: filterTahun,
        filterWilayah: filterWilayah
    },
            function (data, status) {
      ...
      categoriesProdukSeries.push(data[i]['produk']+","+getNum(parseInt(data[i]['total'])),);
      }
  ...
  $.post("index.php/Kdp/monitoringMitra", {
        filterTahun: filterTahun,
        filterWilayah: filterWilayah
    },
            function (data, status) {
      ...
      categoriesMitraNama.push(data[i]['bank'],);
      categoriesMitraSeries.push(data[i]['bank']+","+getNum(parseInt(data[i]['total'])),);
      }
...
credits: {
    ...
    title: {
    text: 'Monitoring KDP Per wilayah',
    style: {
            color: '#000',
...
credits: {
    ...
    title: {
    text: 'Monitoring KDP Per Produk',
    style: {
            color: '#000',
            font: 'bold 12px "Trebuchet MS", Verdana, sans-serif'
        }
