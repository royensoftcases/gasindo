<section class="browse-jobs">
         <div class="container">
            <div class="row justify-content-center">
                <br>
                <br>
                <h5 class="text-center" style="color: blue">UPLOAD EXCEL TARGET BEBAN KLAIM</span></h5>
            </div>
        </div>
        <br>
        <div class="col-md-12">
                ...
                <div class="pull-right">
                    <a href="<?php echo base_url()?>assets/target_beban_klaim_tahun.xlsx"> <button class="btns-success btns-sm" style="font-size: 13px;"><i class="fa fa-file-excel-o"></i> DOWNLOAD EXCEL FORMAT</button></a>
                </div>
            </div>
            <br>
             <br>
    ...
    <div class="modal-dialog" role="document">
     ...
     <div class="modals-header">
            ...
            <div class="modal-body">
                ...
                <form action="index.php/Beban/upload_beban_klaim" method="post" enctype="multipart/form-data" onsubmit="proses();">
...
var tahun_delete = document.getElementById("tahun_delete").value ;
 $("#delete_message").modal("hide");
  $.post("index.php/Beban/deleteUploadBebanKlaim", {
    ...
    $(document).ready(function () {
        ...
        var t = $('#mytable').DataTable({
           ...
           /* "deferLoading": 40,*/
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "index.php/Beban/beban_klaim_header",
            fixedColumns: {
                leftColumns: 0,
                rightColumns: 2
            },
