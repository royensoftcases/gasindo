<section class="browse-jobs">
         <div class="container">
            <div class="row justify-content-center">
                <br>
                <br>
                <h5 class="text-center" style="color: blue">UPLOAD EXCEL RINCIAN LABA-RUGI</span></h5>
            </div>
        </div>
        <br>
        <div class="col-md-12">
                ...
                <div class="pull-right">
                    <a href="<?php echo base_url()?>assets/realisasi_laba_rugi_bulan_tahun.xlsx"> <button class="btns-success btns-sm" style="font-size: 13px;"><i class="fa fa-file-excel-o"></i> DOWNLOAD EXCEL FORMAT</button></a>
                </div>
            </div>
            <br>
             <br>
    ...
    <div class="modal-dialog" role="document">
     ...
     <div class="modals-header">
            ...
            <div class="modal-body">
                ...
                <form action="index.php/LabaRugi/upload_realisasi" method="post" enctype="multipart/form-data" onsubmit="proses();">
...
var bulan_delete = document.getElementById("bulan_delete").value ;
 $("#delete_message").modal("hide");
  $.post("index.php/LabaRugi/deleteUploadRealisasi", {
    ...
    $(document).ready(function () {
        ...
        var t = $('#mytable').DataTable({
           ...
           /* "deferLoading": 40,*/
            ...
            "serverSide": true,
            'order': [1, 'desc'],
            "ajax": "index.php/LabaRugi/realisasi_header",
            fixedColumns: {
                leftColumns: 0,
                rightColumns: 2
            },
